export class verPerfil {
      ...
      imprimirTablas(cantidadAlumnos, detalles, fechaLimite, modalidadRadio, selectorMarcado, tecnologiaRadio, id, db){
        ...
        const divTabla = document.createElement('div')
         ...
         botonBorrar.classList = 'btn btn-light borrarDelPerfil'
         botonBorrar.setAttribute('id', id)
         ...
         botonBorrar.addEventListener('click', (e) => {
            ...
            e.preventDefault()
                  ...
                  db.collection("tablas").doc(id).delete().then(function() {
                        console.log('se borro excitosamente el id ' + id)
